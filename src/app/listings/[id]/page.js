...
import { getReservationsById } from "@/app/actions/getReservations";
        ...
        <div className=" grid grid-cols-5 gap-10">
          <div className="left col-span-5 lg:col-span-3 space-y-4">
            ...
            <div>
              ...
              <p>
                Every booking is backed by Homora Shield — free protection
                against unexpected cancellations, listing mismatches, and
                check-in issues, ensuring peace of mind every step of the way.
              </p>
