...
export default function Navbar() {
  // features for search: location, date, people count
  return (
    <div className=" px-5 md:px-16 flex lg:px-20  justify-between py-3 bg-muted items-center">
      ...
      <div className="search-feature flex items-center gap-3 bg-white border-2 border-gray-300 px-4 py-2 rounded-full">
        <div className="  hover:bg-gray-200  transition-colors duration-200 cursor-pointer px-3 py-1 rounded-full">
          Location
        </div>
        ...
        <div className="  rounded-full bg-red-400 text-white p-2 cursor-pointer hover:scale-[1.05] duration-200 delay-100">
          <Search />
        </div>
      </div>
      <div>
